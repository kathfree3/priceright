...
const otherCityFields = [
  ...
  { field: 'homeType', formValue: 'homeType', type: float64 },
  { field: 'isPreforeclosureAuction', formValue: 'isPreforeclosureAuction', type: int64 },
  { field: 'isNonOwnerOccupied', formValue: 'isNonOwnerOccupied', type: BOOLEAN },
  { field: 'isPremierBuilder', formValue: 'isPremierBuilder', type: int64 },
  { field: 'taxAssessedValue', formValue: 'taxAssessedValue', type: INPUT },
  { field: 'lotAreaValue', formValue: 'lotAreaValue', type: INPUT },
  { field: 'isHomeRec', formValue: 'isHomeRec', type: int64 },
  ...
  { field: 'hasHousingConnectorPermission', formValue: 'hasHousingConnectorPermission', type: float64 },
